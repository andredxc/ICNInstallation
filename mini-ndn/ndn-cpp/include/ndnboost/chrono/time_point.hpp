...
#ifndef NDNBOOST_CHRONO_TIME_POINT_HPP
#define NDNBOOST_CHRONO_TIME_POINT_HPP
...
//----------------------------------------------------------------------------//
    ...
    class time_point
    {
        NDNBOOST_CHRONO_STATIC_ASSERT(ndnboost::chrono::detail::is_duration<Duration>::value,
                NDNBOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_TIME_POINT_MUST_BE_A_NDNBOOST_CHRONO_DURATION, (Duration));
    public:
        typedef Clock                     clock;
    ...
    public:
        ...
        time_point(const time_point<clock, Duration2>& t
                ...
                <
                    ndnboost::is_convertible<Duration2, duration>
                >::type* = 0
        )
        ...
        static NDNBOOST_CHRONO_LIB_CONSTEXPR time_point
        min NDNBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
            return time_point((duration::min)());
        }
        static NDNBOOST_CHRONO_LIB_CONSTEXPR time_point
        max NDNBOOST_PREVENT_MACRO_SUBSTITUTION ()
        {
...
#endif // NDNBOOST_CHRONO_TIME_POINT_HPP
