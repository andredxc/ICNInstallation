...
#ifndef NDNBOOST_DETAIL_WINAPI_BASIC_TYPES_HPP
#define NDNBOOST_DETAIL_WINAPI_BASIC_TYPES_HPP

#include <cstdarg>
#include <ndnboost/cstdint.hpp>
#include <ndnboost/detail/winapi/config.hpp>
...
extern "C" {
    ...
    typedef ndnboost::int64_t LONGLONG_;
    typedef ndnboost::uint64_t ULONGLONG_;
...
#endif // NDNBOOST_DETAIL_WINAPI_BASIC_TYPES_HPP
