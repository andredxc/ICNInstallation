  ...
  namespace math
  {
    namespace tools
    {
      ...
      struct promote_args
      {
         ...
         //
         NDNBOOST_STATIC_ASSERT_MSG((0 == ::ndnboost::is_same<type, long double>::value), "Sorry, but this platform does not have sufficient long double support for the special functions to be reliably implemented.");
#endif
      };
