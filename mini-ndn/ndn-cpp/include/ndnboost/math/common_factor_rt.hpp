...
#ifndef NDNBOOST_MATH_COMMON_FACTOR_RT_HPP
#define NDNBOOST_MATH_COMMON_FACTOR_RT_HPP

#include <ndnboost/math_fwd.hpp>  // self include

#include <ndnboost/config.hpp>  // for NDNBOOST_NESTED_TEMPLATE, etc.
...
#else // NDNBOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
    template < typename T >
    struct gcd_optimal_evaluator
    {
        T  operator ()( T const &a, T const &b )
...
#define NDNBOOST_PRIVATE_GCD_UF( Ut )                  \
    template < >  struct gcd_optimal_evaluator<Ut>  \
    {  Ut  operator ()( Ut a, Ut b ) const  { return gcd_binary( a, b ); }  }

    NDNBOOST_PRIVATE_GCD_UF( unsigned char );
    NDNBOOST_PRIVATE_GCD_UF( unsigned short );
    NDNBOOST_PRIVATE_GCD_UF( unsigned );
    NDNBOOST_PRIVATE_GCD_UF( unsigned long );

#ifdef NDNBOOST_HAS_LONG_LONG
    NDNBOOST_PRIVATE_GCD_UF( ndnboost::ulong_long_type );
#elif defined(NDNBOOST_HAS_MS_INT64)
    NDNBOOST_PRIVATE_GCD_UF( unsigned __int64 );
#endif

#if CHAR_MIN == 0
    NDNBOOST_PRIVATE_GCD_UF( char ); // char is unsigned
#endif

#undef NDNBOOST_PRIVATE_GCD_UF

#define NDNBOOST_PRIVATE_GCD_SF( St, Ut )                            \
    ...
    NDNBOOST_PRIVATE_GCD_SF( signed char, unsigned char );
    NDNBOOST_PRIVATE_GCD_SF( short, unsigned short );
    NDNBOOST_PRIVATE_GCD_SF( int, unsigned );
    NDNBOOST_PRIVATE_GCD_SF( long, unsigned long );

#if CHAR_MIN < 0
    NDNBOOST_PRIVATE_GCD_SF( char, unsigned char ); // char is signed
#endif

#ifdef NDNBOOST_HAS_LONG_LONG
    NDNBOOST_PRIVATE_GCD_SF( ndnboost::long_long_type, ndnboost::ulong_long_type );
#elif defined(NDNBOOST_HAS_MS_INT64)
    NDNBOOST_PRIVATE_GCD_SF( __int64, unsigned __int64 );
#endif

#undef NDNBOOST_PRIVATE_GCD_SF
...
#endif  // NDNBOOST_MATH_COMMON_FACTOR_RT_HPP
