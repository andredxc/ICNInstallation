...
//   Provide implementation up to 10 parameters when NDNBOOST_NO_CXX11_VARIADIC_TEMPLATES is defined.
...
#ifndef NDNBOOST_THREAD_DETAIL_MAKE_TUPLE_INDICES_HPP
#define NDNBOOST_THREAD_DETAIL_MAKE_TUPLE_INDICES_HPP
...
namespace ndnboost
{
  namespace detail
  {
    ...
    {
      NDNBOOST_STATIC_ASSERT_MSG(Sp <= Ep, "make_tuple_indices input error");
