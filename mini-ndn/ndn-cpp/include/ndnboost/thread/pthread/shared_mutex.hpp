#ifndef NDNBOOST_THREAD_PTHREAD_SHARED_MUTEX_HPP
#define NDNBOOST_THREAD_PTHREAD_SHARED_MUTEX_HPP
...
namespace ndnboost
{
    ...
    private:
        ...
        public:
            ...
            {
                NDNBOOST_ASSERT( ! exclusive );
                NDNBOOST_ASSERT( ! upgrade );
                NDNBOOST_ASSERT( shared_count==0 );
            }
            ...
            void assert_lock_shared () const
            {
                NDNBOOST_ASSERT( ! exclusive );
                NDNBOOST_ASSERT( shared_count>0 );
                //NDNBOOST_ASSERT( (! upgrade) || (shared_count>1));
        ...
        state_data state;
        ndnboost::mutex state_change;
        ndnboost::condition_variable shared_cond;
        ndnboost::condition_variable exclusive_cond;
        ndnboost::condition_variable upgrade_cond;
    ...
    public:
        ...
        {
#if defined NDNBOOST_THREAD_PROVIDES_INTERRUPTIONS
            ndnboost::this_thread::disable_interruption do_not_disturb;
#endif
            ndnboost::unique_lock<ndnboost::mutex> lk(state_change);
