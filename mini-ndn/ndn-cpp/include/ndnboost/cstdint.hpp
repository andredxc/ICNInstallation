...
//
#if defined(NDNBOOST_HAS_STDINT_H)					\
  && (!defined(__GLIBC__)					\
...
#if defined(NDNBOOST_WINDOWS) && !defined(_WIN32_WCE) && !defined(NDNBOOST_HAS_STDINT_H)
// Older MSVC don't have stdint.h and have intptr_t/uintptr_t defined in stddef.h
#include <stddef.h>
#endif

// PGI seems to not support intptr_t/uintptr_t properly. NDNBOOST_HAS_STDINT_H is not defined for this compiler by Boost.Config.
#if !defined(__PGIC__)

#if (defined(NDNBOOST_WINDOWS) && !defined(_WIN32_WCE)) \
