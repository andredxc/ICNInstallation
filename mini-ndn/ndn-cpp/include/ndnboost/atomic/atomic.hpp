...
#ifndef NDNBOOST_ATOMIC_ATOMIC_HPP_INCLUDED_
#define NDNBOOST_ATOMIC_ATOMIC_HPP_INCLUDED_

#include <ndnboost/atomic/capabilities.hpp>
#include <ndnboost/atomic/fences.hpp>
#include <ndnboost/atomic/atomic_flag.hpp>
#include <ndnboost/atomic/detail/atomic_template.hpp>
...
#endif // NDNBOOST_ATOMIC_ATOMIC_HPP_INCLUDED_
