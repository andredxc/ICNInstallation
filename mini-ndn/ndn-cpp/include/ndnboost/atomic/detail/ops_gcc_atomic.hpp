...
#ifndef NDNBOOST_ATOMIC_DETAIL_OPS_GCC_ATOMIC_HPP_INCLUDED_
#define NDNBOOST_ATOMIC_DETAIL_OPS_GCC_ATOMIC_HPP_INCLUDED_
...
#if defined(__clang__) && (defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B) || defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B))
...
/*!
 * The function converts \c ndnboost::memory_order values to the compiler-specific constants.
 *
 ...
 *       declared with NDNBOOST_FORCEINLINE. In this case the compilers are able to see that
 ...
 *       inline functions even when marked with NDNBOOST_FORCEINLINE. In this case all atomic
 *       operaions will be executed with seq_cst semantics.
 */
NDNBOOST_FORCEINLINE NDNBOOST_CONSTEXPR int convert_memory_order_to_gcc(memory_order order) NDNBOOST_NOEXCEPT
{
...
struct gcc_atomic_operations
{
    ...
    static NDNBOOST_FORCEINLINE bool is_lock_free(storage_type const volatile& storage) NDNBOOST_NOEXCEPT
    {
...
#if defined(__clang__) && defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B)
...
#if defined(__clang__) && defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B)
...
#endif // NDNBOOST_ATOMIC_DETAIL_OPS_GCC_ATOMIC_HPP_INCLUDED_
