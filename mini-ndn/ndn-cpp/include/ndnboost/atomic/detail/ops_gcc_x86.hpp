...
#ifndef NDNBOOST_ATOMIC_DETAIL_OPS_GCC_X86_HPP_INCLUDED_
#define NDNBOOST_ATOMIC_DETAIL_OPS_GCC_X86_HPP_INCLUDED_
...
#include <ndnboost/atomic/detail/ops_gcc_x86_dcas.hpp>
...
#define NDNBOOST_ATOMIC_DETAIL_TEMP_CAS_REGISTER "rdx"
#else
#define NDNBOOST_ATOMIC_DETAIL_TEMP_CAS_REGISTER "edx"
#endif
...
{
    static NDNBOOST_FORCEINLINE void fence_before(memory_order order) NDNBOOST_NOEXCEPT
    {
        if ((order & memory_order_release) != 0)
            __asm__ __volatile__ ("" ::: "memory");
    }

    static NDNBOOST_FORCEINLINE void fence_after(memory_order order) NDNBOOST_NOEXCEPT
    {
...
#define NDNBOOST_ATOMIC_DETAIL_CAS_LOOP(op, argument, result)\
    __asm__ __volatile__\
    (\
        "xor %%" NDNBOOST_ATOMIC_DETAIL_TEMP_CAS_REGISTER ", %%" NDNBOOST_ATOMIC_DETAIL_TEMP_CAS_REGISTER "\n\t"\
        ".align 16\n\t"\
        "1: movb %[arg], %%dl\n\t"\
        op " %%al, %%dl\n\t"\
        ...
        : [arg] "q" (argument)\
        : "cc", NDNBOOST_ATOMIC_DETAIL_TEMP_CAS_REGISTER, "memory"\
    )
    ...
    static NDNBOOST_FORCEINLINE storage_type fetch_and(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        ...
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("andb", v, res);
        return res;
    }
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("orb", v, res);
        return res;
    }
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("xorb", v, res);
        return res;
    }

#undef NDNBOOST_ATOMIC_DETAIL_CAS_LOOP
};
...
#define NDNBOOST_ATOMIC_DETAIL_CAS_LOOP(op, argument, result)\
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("andw", v, res);
        return res;
    }
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("orw", v, res);
        return res;
    }
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("xorw", v, res);
        return res;
    }
...
#define NDNBOOST_ATOMIC_DETAIL_CAS_LOOP(op, argument, result)\
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("andl", v, res);
        return res;
    }
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("orl", v, res);
        return res;
    }
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("xorl", v, res);
        return res;
    }
...
#define NDNBOOST_ATOMIC_DETAIL_CAS_LOOP(op, argument, result)\
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("andq", v, res);
        return res;
    }
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("orq", v, res);
        return res;
    }
    ...
    {
        storage_type res = storage;
        NDNBOOST_ATOMIC_DETAIL_CAS_LOOP("xorq", v, res);
        return res;
    }
...
#undef NDNBOOST_ATOMIC_DETAIL_TEMP_CAS_REGISTER

#endif // NDNBOOST_ATOMIC_DETAIL_OPS_GCC_X86_HPP_INCLUDED_
