...
#ifndef NDNBOOST_ATOMIC_DETAIL_OPS_MSVC_X86_HPP_INCLUDED_
#define NDNBOOST_ATOMIC_DETAIL_OPS_MSVC_X86_HPP_INCLUDED_
...
#if defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B) || defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B)
#include <ndnboost/cstdint.hpp>
#include <ndnboost/atomic/detail/ops_cas_based.hpp>
#endif
#include <ndnboost/atomic/detail/ops_msvc_common.hpp>
#if !defined(_M_IX86) && !(defined(NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE8) && defined(NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE16))
...
struct msvc_x86_operations_base
{
    ...
    static NDNBOOST_FORCEINLINE void fence_after_load(memory_order) NDNBOOST_NOEXCEPT
    {
        NDNBOOST_ATOMIC_DETAIL_COMPILER_BARRIER();
    ...
    public msvc_x86_operations< typename make_storage_type< 4u, Signed >::type, operations< 4u, Signed > >
{
    ...
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_EXCHANGE_ADD(&storage, v));
    }
    ...
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_EXCHANGE(&storage, v));
    }
    ...
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_AND(&storage, v));
    }
#else
    ...
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_OR(&storage, v));
    }
#else
    ...
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_XOR(&storage, v));
    }
#else
...
#if defined(NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE8)
    ...
    public msvc_x86_operations< typename make_storage_type< 1u, Signed >::type, operations< 1u, Signed > >
{
    ...
    static NDNBOOST_FORCEINLINE storage_type fetch_add(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_EXCHANGE_ADD8(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type exchange(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_EXCHANGE8(&storage, v));
    }
    ...
    {
        storage_type previous = expected;
        storage_type old_val = static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE8(&storage, desired, previous));
        expected = old_val;
        return (previous == old_val);
    }
    ...
    static NDNBOOST_FORCEINLINE storage_type fetch_and(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_AND8(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type fetch_or(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_OR8(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type fetch_xor(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_XOR8(&storage, v));
    }
};
    ...
    public msvc_x86_operations< typename make_storage_type< 1u, Signed >::type, operations< 1u, Signed > >
{
    ...
    static NDNBOOST_FORCEINLINE bool compare_exchange_strong(
        storage_type volatile& storage, storage_type& expected, storage_type desired, memory_order success_order, memory_order) NDNBOOST_NOEXCEPT
    {
...
#if defined(NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE16)
    ...
    public msvc_x86_operations< typename make_storage_type< 2u, Signed >::type, operations< 2u, Signed > >
{
    ...
    static NDNBOOST_FORCEINLINE storage_type fetch_add(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_EXCHANGE_ADD16(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type exchange(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_EXCHANGE16(&storage, v));
    }
    ...
    {
        storage_type previous = expected;
        storage_type old_val = static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE16(&storage, desired, previous));
        expected = old_val;
        return (previous == old_val);
    }
    ...
    static NDNBOOST_FORCEINLINE storage_type fetch_and(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_AND16(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type fetch_or(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_OR16(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type fetch_xor(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_XOR16(&storage, v));
    }
};
...
#if defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B)
...
struct msvc_dcas_x86
{
    ...
    {
        storage_type volatile* p = &storage;
#if defined(NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE64)
        const storage_type old_val = (storage_type)NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE64(p, desired, expected);
    ...
    public msvc_x86_operations< typename make_storage_type< 8u, Signed >::type, operations< 8u, Signed > >
{
    ...
    static NDNBOOST_FORCEINLINE storage_type fetch_add(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_EXCHANGE_ADD64(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type exchange(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_EXCHANGE64(&storage, v));
    }
    ...
    {
        storage_type previous = expected;
        storage_type old_val = static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE64(&storage, desired, previous));
        expected = old_val;
        return (previous == old_val);
    }
    ...
    static NDNBOOST_FORCEINLINE storage_type fetch_and(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_AND64(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type fetch_or(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_OR64(&storage, v));
    }

    static NDNBOOST_FORCEINLINE storage_type fetch_xor(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        return static_cast< storage_type >(NDNBOOST_ATOMIC_INTERLOCKED_XOR64(&storage, v));
    }
};

#endif

#if defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B)
...
struct msvc_dcas_x86_64
{
    ...
    static NDNBOOST_FORCEINLINE void store(storage_type volatile& storage, storage_type v, memory_order) NDNBOOST_NOEXCEPT
    {
        ...
        while (!NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE128(&storage, v, &value)) {}
    }

    static NDNBOOST_FORCEINLINE storage_type load(storage_type const volatile& storage, memory_order) NDNBOOST_NOEXCEPT
    {
        storage_type value = storage_type();
        NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE128(&storage, value, &value);
        return value;
    }
    ...
    static NDNBOOST_FORCEINLINE bool compare_exchange_strong(
        storage_type volatile& storage, storage_type& expected, storage_type desired, memory_order, memory_order) NDNBOOST_NOEXCEPT
    {
        return !!NDNBOOST_ATOMIC_INTERLOCKED_COMPARE_EXCHANGE128(&storage, desired, &expected);
    }
...
#endif // defined(NDNBOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B)
...
#endif // NDNBOOST_ATOMIC_DETAIL_OPS_MSVC_X86_HPP_INCLUDED_
