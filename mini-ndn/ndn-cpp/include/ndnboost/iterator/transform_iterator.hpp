...
#ifndef NDNBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
#define NDNBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
...
namespace ndnboost
{
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public ndnboost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    ndnboost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
  ...
  public:
      ...
      : super_t(x)
    {
        ...
        NDNBOOST_STATIC_ASSERT(is_class<UnaryFunc>::value);
#endif 
    }
...
#endif // NDNBOOST_TRANSFORM_ITERATOR_23022003THW_HPP
