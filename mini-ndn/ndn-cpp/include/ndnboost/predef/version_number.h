...
#ifndef NDNBOOST_PREDEF_VERSION_NUMBER_H
#define NDNBOOST_PREDEF_VERSION_NUMBER_H

/*`
[heading `NDNBOOST_VERSION_NUMBER`]

``
NDNBOOST_VERSION_NUMBER(major,minor,patch)
``
...
*/
#define NDNBOOST_VERSION_NUMBER(major,minor,patch) \
    ( (((major)%100)*10000000) + (((minor)%100)*100000) + ((patch)%100000) )

#define NDNBOOST_VERSION_NUMBER_MAX \
    NDNBOOST_VERSION_NUMBER(99,99,99999)

#define NDNBOOST_VERSION_NUMBER_ZERO \
    NDNBOOST_VERSION_NUMBER(0,0,0)

#define NDNBOOST_VERSION_NUMBER_MIN \
    NDNBOOST_VERSION_NUMBER(0,0,1)

#define NDNBOOST_VERSION_NUMBER_AVAILABLE \
    NDNBOOST_VERSION_NUMBER_MIN

#define NDNBOOST_VERSION_NUMBER_NOT_AVAILABLE \
    NDNBOOST_VERSION_NUMBER_ZERO
