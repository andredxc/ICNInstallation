...
#ifndef NDNBOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
#define NDNBOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
...
class common_slist_algorithms
{
   ...
   static node_ptr get_previous_node(node_ptr p, const node_ptr & this_node)
   {
      for( node_ptr p_next
         ...
         NDNBOOST_INTRUSIVE_INVARIANT_ASSERT(p);
      }
      return p;
   }
...
#endif //NDNBOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
