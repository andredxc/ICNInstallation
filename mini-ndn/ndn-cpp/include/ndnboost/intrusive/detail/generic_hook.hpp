...
#ifndef NDNBOOST_INTRUSIVE_GENERIC_HOOK_HPP
#define NDNBOOST_INTRUSIVE_GENERIC_HOOK_HPP
   ...
   /// @endcond
{
   ...
   bool is_linked() const
   {
      ...
      NDNBOOST_STATIC_ASSERT(( hooktags::safemode_or_autounlink ));
      return !node_algorithms::unique(this->this_ptr());
   }

   void unlink()
   {
      NDNBOOST_STATIC_ASSERT(( (int)hooktags::link_mode == (int)auto_unlink ));
...
#endif //NDNBOOST_INTRUSIVE_GENERIC_HOOK_HPP
