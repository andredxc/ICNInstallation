...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef NDNBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP
#define NDNBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP

#include <ndnboost/intrusive/detail/config_begin.hpp>
#include <cstddef>

#if defined(NDNBOOST_MSVC) || ((defined(_WIN32) || defined(__WIN32__) || defined(WIN32)) && defined(NDNBOOST_INTEL))
   #define NDNBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER
...
inline std::ptrdiff_t offset_from_pointer_to_member(const Member Parent::* ptr_to_member)
{
   ...
   #if defined(NDNBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER)

   //MSVC compliant compilers use their the first 32 bits as offset (even in 64 bit mode)
   union caster_union
   {
      const Member Parent::* ptr_to_member;
      ndnboost::int32_t offset;
   } caster;
   ...
   NDNBOOST_STATIC_ASSERT( sizeof(caster) == sizeof(ndnboost::int32_t) );
   ...
   #elif defined(__GNUC__)   || defined(__HP_aCC) || defined(NDNBOOST_INTEL) || \
...
#ifdef NDNBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER
#undef NDNBOOST_INTRUSIVE_MSVC_ABI_PTR_TO_MEMBER
#endif

#include <ndnboost/intrusive/detail/config_end.hpp>

#endif   //#ifndef NDNBOOST_INTRUSIVE_DETAIL_PARENT_FROM_MEMBER_HPP
