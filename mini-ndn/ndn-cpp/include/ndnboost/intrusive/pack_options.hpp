...
#ifndef NDNBOOST_INTRUSIVE_PACK_OPTIONS_HPP
#define NDNBOOST_INTRUSIVE_PACK_OPTIONS_HPP
...
#endif   //!defined(NDNBOOST_INTRUSIVE_VARIADIC_TEMPLATES)

#define NDNBOOST_INTRUSIVE_OPTION_TYPE(OPTION_NAME, TYPE, TYPEDEF_EXPR, TYPEDEF_NAME) \
template< class TYPE> \
struct OPTION_NAME \
{ \
   template<class Base> \
...
#define NDNBOOST_INTRUSIVE_OPTION_CONSTANT(OPTION_NAME, TYPE, VALUE, CONSTANT_NAME) \
template< TYPE VALUE> \
struct OPTION_NAME \
{ \
   template<class Base> \
...
#else    //#ifndef NDNBOOST_INTRUSIVE_DOXYGEN_INVOKED

//! This class is a utility that takes:
//!   - a default options class defining initial static constant
//!   and typedefs
//!   - several options defined with NDNBOOST_INTRUSIVE_OPTION_CONSTANT and
...
//!
//! \code
//!   NDNBOOST_INTRUSIVE_OPTION_TYPE(my_pointer, VoidPointer, VoidPointer, my_pointer_type)
//!   NDNBOOST_INTRUSIVE_OPTION_CONSTANT(incremental, bool, Enabled, is_incremental)
//! \endcode
//!
...
//! <code>ndnboost::intrusive::pack_options</code>,
...
//!   //    struct my_pointer
//!   //    { unspecified_content };
//!   NDNBOOST_INTRUSIVE_OPTION_TYPE(my_pointer, VoidPointer, ndnboost::remove_pointer<VoidPointer>::type, my_pointer_type)
//!
//!   struct empty_default{};
//!
//!   typedef pack_options< empty_default, typename my_pointer<void*> >::type::my_pointer_type type;
//!
//!   NDNBOOST_STATIC_ASSERT(( ndnboost::is_same<type, void>::value ));
//!
//! \endcode
#define NDNBOOST_INTRUSIVE_OPTION_TYPE(OPTION_NAME, TYPE, TYPEDEF_EXPR, TYPEDEF_NAME)
...
//!
//!   NDNBOOST_STATIC_ASSERT(( is_incremental == true ));
//!
//! \endcode
#define NDNBOOST_INTRUSIVE_OPTION_CONSTANT(OPTION_NAME, TYPE, VALUE, CONSTANT_NAME)

#endif   //#ifndef NDNBOOST_INTRUSIVE_DOXYGEN_INVOKED
...
#endif   //#ifndef NDNBOOST_INTRUSIVE_PACK_OPTIONS_HPP
