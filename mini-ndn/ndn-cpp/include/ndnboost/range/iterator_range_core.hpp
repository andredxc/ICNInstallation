...
#include <ndnboost/range/has_range_iterator.hpp>
...
incrementable_t test_traversal_tag(ndnboost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(ndnboost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(ndnboost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef ndnboost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef ndnboost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef ndnboost::random_access_traversal_tag type;
};
...
{
    typedef
        NDNBOOST_DEDUCED_TYPENAME iterator_traversal<IteratorT>::type
    traversal_t;
    ...
    typedef
        NDNBOOST_DEDUCED_TYPENAME pure_iterator_traversal_impl<traversal_i>::type
    type;
};
...
public:
   ...
   {
       NDNBOOST_ASSERT(n >= difference_type());
...
public:
    typedef NDNBOOST_DEDUCED_TYPENAME base_type::difference_type difference_type;
    typedef NDNBOOST_DEDUCED_TYPENAME base_type::reference reference;

    reference back() const
    {
        NDNBOOST_ASSERT(!this->empty());
        return *ndnboost::prior(this->m_End);
    }
...
public:
    typedef NDNBOOST_DEDUCED_TYPENAME
        ndnboost::mpl::if_<
            ndnboost::mpl::or_<
                ndnboost::is_abstract<
                    NDNBOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                ndnboost::is_array<
                    NDNBOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                ndnboost::is_function<
                    NDNBOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
            NDNBOOST_DEDUCED_TYPENAME base_type::reference,
            NDNBOOST_DEDUCED_TYPENAME base_type::value_type
    ...
    // type.
    typedef NDNBOOST_DEDUCED_TYPENAME base_type::difference_type difference_type;
    typedef NDNBOOST_DEDUCED_TYPENAME base_type::size_type size_type;
    typedef NDNBOOST_DEDUCED_TYPENAME base_type::reference reference;
...
public:
    ...
    {
        NDNBOOST_ASSERT(at >= 0);
        NDNBOOST_ASSERT(static_cast<typename base_type::size_type>(at) < size());
    ...
    NDNBOOST_DEDUCED_TYPENAME base_type::size_type size() const
    {
        ...
        */
        ...
        class iterator_range
            : public iterator_range_detail::iterator_range_base<
                    IteratorT,
                    NDNBOOST_DEDUCED_TYPENAME iterator_range_detail::pure_iterator_traversal<IteratorT>::type
                >
        {
            ...
            struct is_compatible_range
                : is_convertible<
                    NDNBOOST_DEDUCED_TYPENAME mpl::eval_if<
                        ...
                        mpl::identity<void>
                    >::type,
                    NDNBOOST_DEDUCED_TYPENAME base_type::iterator
                >
            {
            };
        ...
        public:
            ...
            iterator_range& advance_begin(
                NDNBOOST_DEDUCED_TYPENAME base_type::difference_type n)
            {
                std::advance(this->m_Begin, n);
                return *this;
            }
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline NDNBOOST_DEDUCED_TYPENAME ndnboost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline NDNBOOST_DEDUCED_TYPENAME ndnboost::enable_if<
            mpl::not_<ndnboost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, ndnboost::next(first, n));
        }
