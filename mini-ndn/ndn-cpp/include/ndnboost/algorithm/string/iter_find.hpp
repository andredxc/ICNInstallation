...
#ifndef NDNBOOST_STRING_ITER_FIND_HPP
#define NDNBOOST_STRING_ITER_FIND_HPP

#include <ndnboost/algorithm/string/config.hpp>
#include <algorithm>
#include <iterator>
#include <ndnboost/iterator/transform_iterator.hpp>
...
#include <ndnboost/algorithm/string/find_iterator.hpp>
...
//  iterate find ---------------------------------------------------//
        ...
        /*!
            ...
            \param Result A 'container container' to contain the result of search.
                ...
                Typical type of the result is 
                    \c std::vector<ndnboost::iterator_range<iterator>>
        ...
        */
            ...
            FinderT Finder )
        {
            ...
            iterator_range<NDNBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_input(::ndnboost::as_literal(Input));
            ...
            input_iterator_type InputEnd=::ndnboost::end(lit_input);

            typedef transform_iterator<copy_range_type, find_iterator_type>
                transform_iter_type;
    
            transform_iter_type itBegin=
                ::ndnboost::make_transform_iterator( 
                    find_iterator_type( ::ndnboost::begin(lit_input), InputEnd, Finder ),
                    copy_range_type());
...
#endif  // NDNBOOST_STRING_ITER_FIND_HPP
