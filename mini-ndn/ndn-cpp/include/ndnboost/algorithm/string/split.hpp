...
#ifndef NDNBOOST_STRING_SPLIT_HPP
#define NDNBOOST_STRING_SPLIT_HPP

#include <ndnboost/algorithm/string/config.hpp>

#include <ndnboost/algorithm/string/iter_find.hpp>
...
/*! \file
    ...
    or \c std::list<ndnboost::iterator_range<std::string::iterator>>
*/
...
//  tokenize  -------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::ndnboost::algorithm::iter_split(
                Result,
                Input,
                ::ndnboost::algorithm::token_finder( Pred, eCompress ) );         
        }
...
#endif  // NDNBOOST_STRING_SPLIT_HPP
