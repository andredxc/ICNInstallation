...
#ifndef NDNBOOST_STRING_FIND_ITERATOR_HPP
#define NDNBOOST_STRING_FIND_ITERATOR_HPP
...
#include <ndnboost/algorithm/string/detail/find_iterator.hpp>
...
//  find_iterator -----------------------------------------------//
        ...
        */
        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<NDNBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::ndnboost::as_literal(Col));
                m_Match=::ndnboost::make_iterator_range(::ndnboost::begin(lit_col), ::ndnboost::begin(lit_col));
                m_End=::ndnboost::end(lit_col);
        ...
        inline find_iterator< 
            NDNBOOST_STRING_TYPENAME range_iterator<RangeT>::type>
        make_find_iterator(
            RangeT& Collection,
            FinderT Finder)
        {
            return find_iterator<NDNBOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<NDNBOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::ndnboost::as_literal(Col));
                m_Match=make_iterator_range(::ndnboost::begin(lit_col), ::ndnboost::begin(lit_col));
                m_Next=::ndnboost::begin(lit_col);
                m_End=::ndnboost::end(lit_col);
        ...
        make_split_iterator(
            ...
            FinderT Finder)
        {
            return split_iterator<NDNBOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
...
#endif  // NDNBOOST_STRING_FIND_ITERATOR_HPP
