...
#ifndef NDNBOOST_MPL_JOINT_VIEW_HPP_INCLUDED
#define NDNBOOST_MPL_JOINT_VIEW_HPP_INCLUDED
...
template<
      typename NDNBOOST_MPL_AUX_NA_PARAM(Sequence1_)
    , typename NDNBOOST_MPL_AUX_NA_PARAM(Sequence2_)
    >
struct joint_view
{
...
NDNBOOST_MPL_AUX_NA_SPEC(2, joint_view)

}}

#endif // NDNBOOST_MPL_JOINT_VIEW_HPP_INCLUDED
