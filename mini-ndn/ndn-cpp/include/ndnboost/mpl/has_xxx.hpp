...
#   elif NDNBOOST_WORKAROUND(NDNBOOST_MSVC, <= 1400) \
      || (NDNBOOST_WORKAROUND(NDNBOOST_MSVC, NDNBOOST_TESTED_AT(1800)) && defined(__CUDACC__)) \
...
#     else
#       define NDNBOOST_MPL_HAS_XXX_NO_WRAPPED_TYPES 0
#     endif
#   endif
...
#     else
#       define NDNBOOST_MPL_HAS_XXX_NO_EXPLICIT_TEST_FUNCTION 0
#     endif
#   endif
...
#     else
#       define NDNBOOST_MPL_HAS_XXX_NEEDS_TEMPLATE_SFINAE 0
#     endif
#   endif
