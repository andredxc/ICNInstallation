...
#ifndef NDNBOOST_MPL_REMOVE_HPP_INCLUDED
#define NDNBOOST_MPL_REMOVE_HPP_INCLUDED
...
NDNBOOST_MPL_AUX_INSERTER_ALGORITHM_DEF(3, remove)

}}

#endif // NDNBOOST_MPL_REMOVE_HPP_INCLUDED
