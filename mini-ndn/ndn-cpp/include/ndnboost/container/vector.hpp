...
#ifndef NDNBOOST_CONTAINER_CONTAINER_VECTOR_HPP
#define NDNBOOST_CONTAINER_CONTAINER_VECTOR_HPP
...
#include <ndnboost/container/detail/advanced_insert_int.hpp>
...
//#define NDNBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER

namespace container_detail {

#ifndef NDNBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
...
class vec_iterator
{
   ...
   typedef typename ndnboost::intrusive::pointer_traits<Pointer>::element_type         value_type;
   typedef typename ndnboost::intrusive::pointer_traits<Pointer>::difference_type      difference_type;
   typedef typename if_c
      < IsConst
      , typename ndnboost::intrusive::pointer_traits<Pointer>::template
                                 rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef typename ndnboost::intrusive::pointer_traits<Pointer>                       ptr_traits;
   ...
   public:
   const Pointer &get_ptr() const NDNBOOST_CONTAINER_NOEXCEPT
   {  return   m_ptr;  }

   Pointer &get_ptr() NDNBOOST_CONTAINER_NOEXCEPT
   {  return   m_ptr;  }

   explicit vec_iterator(Pointer ptr) NDNBOOST_CONTAINER_NOEXCEPT
      : m_ptr(ptr)
   {}
   ...
   //Constructors
   vec_iterator() NDNBOOST_CONTAINER_NOEXCEPT
      #ifndef NDEBUG
      : m_ptr()
      #else
   ...
   vec_iterator(vec_iterator<Pointer, false> const& other) NDNBOOST_CONTAINER_NOEXCEPT
      :  m_ptr(other.get_ptr())
   {}

   //Pointer like operators
   reference operator*()   const NDNBOOST_CONTAINER_NOEXCEPT
   {  return *m_ptr;  }

   pointer operator->()  const NDNBOOST_CONTAINER_NOEXCEPT
   {  return ::ndnboost::intrusive::pointer_traits<pointer>::pointer_to(this->operator*());  }

   reference operator[](difference_type off) const NDNBOOST_CONTAINER_NOEXCEPT
   {  return m_ptr[off];   }

   //Increment / Decrement
   vec_iterator& operator++() NDNBOOST_CONTAINER_NOEXCEPT
   { ++m_ptr;  return *this; }

   vec_iterator operator++(int) NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //Arithmetic
   vec_iterator& operator+=(difference_type off) NDNBOOST_CONTAINER_NOEXCEPT
   {  m_ptr += off; return *this;   }

   vec_iterator& operator-=(difference_type off) NDNBOOST_CONTAINER_NOEXCEPT
   {  m_ptr -= off; return *this;   }

   friend vec_iterator operator+(const vec_iterator &x, difference_type off) NDNBOOST_CONTAINER_NOEXCEPT
   {  return vec_iterator(x.m_ptr+off);  }

   friend vec_iterator operator+(difference_type off, vec_iterator right) NDNBOOST_CONTAINER_NOEXCEPT
   {  right.m_ptr += off;  return right; }

   friend vec_iterator operator-(vec_iterator left, difference_type off) NDNBOOST_CONTAINER_NOEXCEPT
   {  left.m_ptr -= off;  return left; }

   friend difference_type operator-(const vec_iterator &left, const vec_iterator& right) NDNBOOST_CONTAINER_NOEXCEPT
   {  return left.m_ptr - right.m_ptr;   }

   //Comparison operators
   friend bool operator==   (const vec_iterator& l, const vec_iterator& r) NDNBOOST_CONTAINER_NOEXCEPT
...
template<class Pointer, bool IsConst>
const Pointer &vector_iterator_get_ptr(const container_detail::vec_iterator<Pointer, IsConst> &it) NDNBOOST_CONTAINER_NOEXCEPT
{  return   it.get_ptr();  }

template<class Pointer, bool IsConst>
Pointer &get_ptr(container_detail::vec_iterator<Pointer, IsConst> &it) NDNBOOST_CONTAINER_NOEXCEPT
{  return  it.get_ptr();  }

namespace container_detail {

#else //ifndef NDNBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER

template< class MaybeConstPointer
        , bool ElementTypeIsConst
            = is_const< typename ndnboost::intrusive::pointer_traits<MaybeConstPointer>::element_type>::value >
struct vector_get_ptr_pointer_to_non_const
{
   typedef MaybeConstPointer                                         const_pointer;
   typedef ndnboost::intrusive::pointer_traits<const_pointer>           pointer_traits_t;
   ...
   static return_type get_ptr(const const_pointer &ptr) NDNBOOST_CONTAINER_NOEXCEPT
   {  return ndnboost::intrusive::pointer_traits<return_type>::const_cast_from(ptr);  }
};
...
struct vector_get_ptr_pointer_to_non_const<Pointer, false>
{
   ...
   static return_type get_ptr(const Pointer &ptr) NDNBOOST_CONTAINER_NOEXCEPT
   {  return ptr;  }
};
...
typename container_detail::vector_get_ptr_pointer_to_non_const<MaybeConstPointer>::return_type
   vector_iterator_get_ptr(const MaybeConstPointer &ptr) NDNBOOST_CONTAINER_NOEXCEPT
{
...
#endif   //#ifndef NDNBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
...
struct vector_value_traits
{
   ...
   static const bool trivial_dctr = ndnboost::has_trivial_destructor<value_type>::value;
   static const bool trivial_dctr_after_move = ::ndnboost::has_trivial_destructor_after_move<value_type>::value;
...
{
   private:
   NDNBOOST_MOVABLE_BUT_NOT_COPYABLE(vector_alloc_holder)

   public:
   typedef ndnboost::container::allocator_traits<Allocator> allocator_traits_type;
   ...
   vector_alloc_holder()
      NDNBOOST_CONTAINER_NOEXCEPT_IF(::ndnboost::has_nothrow_default_constructor<Allocator>::value)
      : Allocator(), m_start(), m_size(), m_capacity()
   {}

   //Constructor, does not throw
   template<class AllocConvertible>
   explicit vector_alloc_holder(NDNBOOST_FWD_REF(AllocConvertible) a) NDNBOOST_CONTAINER_NOEXCEPT
      : Allocator(ndnboost::forward<AllocConvertible>(a)), m_start(), m_size(), m_capacity()
   {}

   //Constructor, does not throw
   template<class AllocConvertible>
   vector_alloc_holder(uninitialized_size_t, NDNBOOST_FWD_REF(AllocConvertible) a, size_type initial_size)
      : Allocator(ndnboost::forward<AllocConvertible>(a))
      , m_start()
   ...
   vector_alloc_holder(NDNBOOST_RV_REF(vector_alloc_holder) holder) NDNBOOST_CONTAINER_NOEXCEPT
      : Allocator(ndnboost::move(static_cast<Allocator&>(holder)))
   ...
   ~vector_alloc_holder() NDNBOOST_CONTAINER_NOEXCEPT
   {
      if(this->m_capacity){
   ...
   std::pair<pointer, bool>
      allocation_command(ndnboost::container::allocation_type command,
   ...
   void swap(vector_alloc_holder &x) NDNBOOST_CONTAINER_NOEXCEPT
   {
      ndnboost::container::swap_dispatch(this->m_start, x.m_start);
      ndnboost::container::swap_dispatch(this->m_size, x.m_size);
      ndnboost::container::swap_dispatch(this->m_capacity, x.m_capacity);
   }

   void move_from_empty(vector_alloc_holder &x) NDNBOOST_CONTAINER_NOEXCEPT
   {
   ...
   Allocator &alloc() NDNBOOST_CONTAINER_NOEXCEPT
   {  return *this;  }

   const Allocator &alloc() const NDNBOOST_CONTAINER_NOEXCEPT
   {  return *this;  }

   const pointer   &start() const     NDNBOOST_CONTAINER_NOEXCEPT {  return m_start;  }
   const size_type &capacity() const  NDNBOOST_CONTAINER_NOEXCEPT {  return m_capacity;  }
   void start(const pointer &p)       NDNBOOST_CONTAINER_NOEXCEPT {  m_start = p;  }
   void capacity(const size_type &c)  NDNBOOST_CONTAINER_NOEXCEPT {  m_capacity = c;  }
};
   ...
   : public Allocator
{
   ...
   template<class AllocConvertible>
   explicit vector_alloc_holder(NDNBOOST_FWD_REF(AllocConvertible) a) NDNBOOST_CONTAINER_NOEXCEPT
      : Allocator(ndnboost::forward<AllocConvertible>(a)), m_size()
   {}
   ...
   vector_alloc_holder(NDNBOOST_RV_REF(vector_alloc_holder) holder)
      : Allocator(ndnboost::move(static_cast<Allocator&>(holder)))
      , m_size(holder.m_size) //Size is initialized here so vector should only call uninitialized_xxx after this
   {
      ::ndnboost::container::uninitialized_move_alloc_n
         (this->alloc(), container_detail::to_raw_pointer(holder.start()), m_size, container_detail::to_raw_pointer(this->start()));
   }

   template<class OtherAllocator, class OtherAllocatorVersion>
   vector_alloc_holder(NDNBOOST_RV_REF_BEG vector_alloc_holder<OtherAllocator, OtherAllocatorVersion> NDNBOOST_RV_REF_END holder)
      : Allocator()
   ...
   void first_allocation_same_allocator_type(size_type) NDNBOOST_CONTAINER_NOEXCEPT
   {}
   ...
   pointer start() const       NDNBOOST_CONTAINER_NOEXCEPT {  return Allocator::internal_storage();  }
   size_type  capacity() const NDNBOOST_CONTAINER_NOEXCEPT {  return Allocator::internal_capacity;  }
   size_type   m_size;
   ...
   void priv_swap_members_impl(vector_alloc_holder<OtherAllocator, OtherAllocatorVersion> &x)
   {
      ...
      if(this->m_size < x.m_size){
         ndnboost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_this, this->m_size, first_x, x.m_size);
      }
      else{
         ndnboost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_x, x.m_size, first_this, this->m_size);
      }
      ndnboost::container::swap_dispatch(this->m_size, x.m_size);
   }
};
...
class vector
{
   ...
   ndnboost::container::container_detail::vector_alloc_holder
      <Allocator, alloc_version>                            m_holder;
   typedef allocator_traits<Allocator>                      allocator_traits_type;
   template <class U, class UAllocator>
   friend class vector;

   typedef typename ::ndnboost::container::allocator_traits
   ...
   typedef typename ::ndnboost::container::allocator_traits<Allocator>::const_pointer     const_pointer;
   typedef typename ::ndnboost::container::allocator_traits<Allocator>::reference         reference;
   typedef typename ::ndnboost::container::allocator_traits<Allocator>::const_reference   const_reference;
   typedef typename ::ndnboost::container::allocator_traits<Allocator>::size_type         size_type;
   typedef typename ::ndnboost::container::allocator_traits<Allocator>::difference_type   difference_type;
   typedef Allocator                                                                   allocator_type;
   typedef Allocator                                                                   stored_allocator_type;
   #if defined NDNBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER && !defined(NDNBOOST_CONTAINER_DOXYGEN_INVOKED)
   typedef NDNBOOST_CONTAINER_IMPDEF(pointer)                                             iterator;
   typedef NDNBOOST_CONTAINER_IMPDEF(const_pointer)                                       const_iterator;
   #else
   typedef NDNBOOST_CONTAINER_IMPDEF(iterator_impl)                                       iterator;
   typedef NDNBOOST_CONTAINER_IMPDEF(const_iterator_impl)                                 const_iterator;
   #endif
   typedef NDNBOOST_CONTAINER_IMPDEF(std::reverse_iterator<iterator>)                     reverse_iterator;
   typedef NDNBOOST_CONTAINER_IMPDEF(std::reverse_iterator<const_iterator>)               const_reverse_iterator;

   #ifndef NDNBOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   NDNBOOST_COPYABLE_AND_MOVABLE(vector)
   ...
   //!
   //! <b>Complexity</b>: Constant.
   explicit vector(const Allocator& a) NDNBOOST_CONTAINER_NOEXCEPT
      : m_holder(a)
   {}
   ...
   {
      ndnboost::container::uninitialized_value_init_alloc_n
   ...
   vector(size_type n, default_init_t)
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ndnboost::container::uninitialized_default_init_alloc_n
         (this->m_holder.alloc(), n, container_detail::to_raw_pointer(this->m_holder.start()));
   }
   ...
   vector(size_type n, const T& value)
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ndnboost::container::uninitialized_fill_alloc_n
   ...
   vector(const vector &x)
      :  m_holder( container_detail::uninitialized_size
                 ...
                 , x.size())
   {
      ::ndnboost::container::uninitialized_copy_alloc_n
   ...
   //!
   //! <b>Complexity</b>: Constant.
   vector(NDNBOOST_RV_REF(vector) x) NDNBOOST_CONTAINER_NOEXCEPT
      :  m_holder(ndnboost::move(x.m_holder))
   {}
   ...
   vector(NDNBOOST_RV_REF_BEG vector<T, OtherAllocator> NDNBOOST_RV_REF_END x
   ...
   #endif   //!defined(NDNBOOST_CONTAINER_DOXYGEN_INVOKED)
   ...
   {
      ::ndnboost::container::uninitialized_copy_alloc_n_source
         ( this->m_holder.alloc(), container_detail::to_raw_pointer(x.m_holder.start())
         , x.size(), container_detail::to_raw_pointer(this->m_holder.start()));
   }
   ...
   vector(NDNBOOST_RV_REF(vector) x, const allocator_type &a)
      :  m_holder(container_detail::uninitialized_size, a, x.size())
   {
      if(x.m_holder.alloc() == a){
         ...
         ::ndnboost::container::uninitialized_move_alloc_n_source
            ( this->m_holder.alloc(), container_detail::to_raw_pointer(x.m_holder.start())
   ...
   ~vector() NDNBOOST_CONTAINER_NOEXCEPT
   {
      ndnboost::container::destroy_alloc_n
   ...
   vector& operator=(NDNBOOST_COPY_ASSIGN_REF(vector) x)
   {
      if (&x != this){
   ...
   vector& operator=(NDNBOOST_RV_REF(vector) x)
      NDNBOOST_CONTAINER_NOEXCEPT_IF(allocator_traits_type::propagate_on_container_move_assignment::value)
   {
      this->priv_move_assign(ndnboost::move(x));
      return *this;
   }
   ...
   typename container_detail::enable_if_c
                           ...
                           , vector& >::type
      operator=(NDNBOOST_RV_REF_BEG vector<value_type, OtherAllocator> NDNBOOST_RV_REF_END x)
   {
      this->priv_move_assign(ndnboost::move(x));
      return *this;
   }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   allocator_type get_allocator() const NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Note</b>: Non-standard extension.
   stored_allocator_type &get_stored_allocator() NDNBOOST_CONTAINER_NOEXCEPT
   {  return this->m_holder.alloc(); }
   ...
   //!
   //! <b>Note</b>: Non-standard extension.
   const stored_allocator_type &get_stored_allocator() const NDNBOOST_CONTAINER_NOEXCEPT
   {  return this->m_holder.alloc(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   iterator begin() NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_iterator begin() const NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   iterator end() NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_iterator end() const NDNBOOST_CONTAINER_NOEXCEPT
   { return this->cend(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   reverse_iterator rbegin() NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reverse_iterator rbegin() const NDNBOOST_CONTAINER_NOEXCEPT
   { return this->crbegin(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   reverse_iterator rend() NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reverse_iterator rend() const NDNBOOST_CONTAINER_NOEXCEPT
   { return this->crend(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_iterator cbegin() const NDNBOOST_CONTAINER_NOEXCEPT
   { return const_iterator(this->m_holder.start()); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_iterator cend() const NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reverse_iterator crbegin() const NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reverse_iterator crend() const NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   bool empty() const NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   size_type size() const NDNBOOST_CONTAINER_NOEXCEPT
   { return this->m_holder.m_size; }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   size_type capacity() const NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   reference         front() NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reference   front() const NDNBOOST_CONTAINER_NOEXCEPT
   { return *this->m_holder.start(); }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   reference         back() NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reference   back()  const NDNBOOST_CONTAINER_NOEXCEPT
   { return this->m_holder.start()[this->m_holder.m_size - 1]; }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   reference operator[](size_type n) NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const_reference operator[](size_type n) const NDNBOOST_CONTAINER_NOEXCEPT
   { return this->m_holder.start()[n]; }
   ...
   //!
   //! <b>Complexity</b>: Constant.
   T* data() NDNBOOST_CONTAINER_NOEXCEPT
   ...
   //!
   //! <b>Complexity</b>: Constant.
   const T * data()  const NDNBOOST_CONTAINER_NOEXCEPT
   { return container_detail::to_raw_pointer(this->m_holder.start()); }
   ...
   #if defined(NDNBOOST_CONTAINER_PERFECT_FORWARDING) || defined(NDNBOOST_CONTAINER_DOXYGEN_INVOKED)
   ...
   void emplace_back(Args &&...args)
   {
      ...
      if (this->m_holder.m_size < this->m_holder.capacity()){
         ...
         allocator_traits_type::construct(this->m_holder.alloc(), back_pos, ::ndnboost::forward<Args>(args)...);
         ++this->m_holder.m_size;
      }
      else{
         typedef container_detail::insert_emplace_proxy<Allocator, T*, Args...> type;
         this->priv_forward_range_insert_no_capacity
            (vector_iterator_get_ptr(this->cend()), 1, type(::ndnboost::forward<Args>(args)...), alloc_version());
      }
   }
   ...
   iterator emplace(const_iterator position, Args && ...args)
   {
      ...
      return this->priv_forward_range_insert( vector_iterator_get_ptr(position), 1
                                            , type(::ndnboost::forward<Args>(args)...), alloc_version());
   }
   ...
   void emplace_back(NDNBOOST_PP_ENUM(n, NDNBOOST_CONTAINER_PP_PARAM_LIST, _))                              \
   {                                                                                                  \
      T* back_pos = container_detail::to_raw_pointer                                                  \
         (this->m_holder.start()) + this->m_holder.m_size;                                            \
      if (this->m_holder.m_size < this->m_holder.capacity()){                                         \
         allocator_traits_type::construct (this->m_holder.alloc()                                     \
            , back_pos NDNBOOST_PP_ENUM_TRAILING(n, NDNBOOST_CONTAINER_PP_PARAM_FORWARD, _) );              \
         ++this->m_holder.m_size;                                                                     \
      }                                                                                               \
      else{                                                                                           \
         typedef container_detail::NDNBOOST_PP_CAT(insert_emplace_proxy_arg, n)                          \
            <Allocator, T* NDNBOOST_PP_ENUM_TRAILING_PARAMS(n, P)> type;                                 \
         this->priv_forward_range_insert_no_capacity                                                  \
            ( vector_iterator_get_ptr(this->cend()), 1                                                \
            , type(NDNBOOST_PP_ENUM(n, NDNBOOST_CONTAINER_PP_PARAM_FORWARD, _)), alloc_version());          \
      }                                                                                               \
   }                                                                                                  \
                                                                                                      \
   NDNBOOST_PP_EXPR_IF(n, template<) NDNBOOST_PP_ENUM_PARAMS(n, class P) NDNBOOST_PP_EXPR_IF(n, >)             \
   ...
   void push_back(T &&x);
   #else
   NDNBOOST_MOVE_CONVERSION_AWARE_CATCH(push_back, T, void, priv_push_back)
   #endif
   ...
   #else
   NDNBOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(insert, T, iterator, priv_insert, const_iterator, const_iterator)
   #endif
   ...
   {
      NDNBOOST_ASSERT(container_detail::is_input_iterator<InIt>::value ||
   ...
   void pop_back() NDNBOOST_CONTAINER_NOEXCEPT
   {
   ...
   iterator erase(const_iterator position)
   {
      ...
      this->priv_destroy(::ndnboost::move(pos + 1, beg + this->m_holder.m_size, pos));
      --this->m_holder.m_size;
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      if (first != last){
         T* const end_pos = container_detail::to_raw_pointer(this->m_holder.start()) + this->m_holder.m_size;
         T* const ptr = container_detail::to_raw_pointer(ndnboost::move
         ...
         ndnboost::container::destroy_alloc_n(this->get_stored_allocator(), ptr, destroyed);
   ...
   //!
   //! <b>Complexity</b>: Constant.
   void swap(vector& x) NDNBOOST_CONTAINER_NOEXCEPT_IF((!container_detail::is_version<Allocator, 0>::value))
   {
   ...
   void clear() NDNBOOST_CONTAINER_NOEXCEPT
   {  this->priv_destroy_all();  }
   ...
   template<class OtherAllocator>
   void priv_move_assign(NDNBOOST_RV_REF_BEG vector<T, OtherAllocator> NDNBOOST_RV_REF_END x
      , typename container_detail::enable_if_c
         < container_detail::is_version<OtherAllocator, 0>::value >::type * = 0)
   {
      ...
      ndnboost::container::move_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
           ...
           container_detail::is_same<OtherAllocator, allocator_type>::value>::type * = 0)
   {
      ...
      //Else do a one by one move
         ...
         this->assign( ndnboost::make_move_iterator(x.begin())
                     , ndnboost::make_move_iterator(x.end()));
      }
   }
         ...
         < container_detail::is_version<OtherAllocator, 0>::value >::type * = 0)
   {
      ...
      const size_type this_sz  = m_holder.m_size;
      const size_type other_sz = static_cast<size_type>(x.m_holder.m_size);
      ndnboost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
      this->m_holder.m_size = other_sz;
   }
   ...
   container_detail::insert_range_proxy<Allocator, ndnboost::move_iterator<T*>, T*> priv_dummy_empty_proxy()
   {
      return container_detail::insert_range_proxy<Allocator, ndnboost::move_iterator<T*>, T*>
         (::ndnboost::make_move_iterator((T *)0));
   }
   ...
   void priv_reserve(size_type new_cap, allocator_v2)
   {
      ...
      if(same_buffer_start){
         #ifdef NDNBOOST_CONTAINER_VECTOR_ALLOC_STATS
         ++this->num_expand_fwd;
         #endif
         this->m_holder.capacity(real_cap);
      }
   ...
   void priv_destroy(value_type* p) NDNBOOST_CONTAINER_NOEXCEPT
   {
      if(!value_traits::trivial_dctr)
         allocator_traits_type::destroy(this->get_stored_allocator(), p);
   }

   void priv_destroy_last_n(size_type n) NDNBOOST_CONTAINER_NOEXCEPT
   {
      T* const end_pos = container_detail::to_raw_pointer(this->m_holder.start()) + this->m_holder.m_size;
      ndnboost::container::destroy_alloc_n(this->get_stored_allocator(), end_pos-n, n);
   ...
   void priv_destroy_all() NDNBOOST_CONTAINER_NOEXCEPT
   {
      ndnboost::container::destroy_alloc_n
         (this->get_stored_allocator(), container_detail::to_raw_pointer(this->m_holder.start()), this->m_holder.m_size);
      this->m_holder.m_size = 0;
   ...
   template<class U>
   iterator priv_insert(const const_iterator &p, NDNBOOST_FWD_REF(U) x)
   {
      return this->priv_forward_range_insert
         ( vector_iterator_get_ptr(p), 1, container_detail::get_insert_value_proxy<T*, Allocator>
            (::ndnboost::forward<U>(x)), alloc_version());
   }
   ...
   container_detail::insert_move_proxy<Allocator, T*> priv_single_insert_proxy(NDNBOOST_RV_REF(T) x)
   {  return container_detail::insert_move_proxy<Allocator, T*> (x);  }

   template <class U>
   void priv_push_back(NDNBOOST_FWD_REF(U) u)
   {
      if (this->m_holder.m_size < this->m_holder.capacity()){
         //There is more memory, just construct a new object at the end
         allocator_traits_type::construct
            ( this->m_holder.alloc()
            , container_detail::to_raw_pointer(this->m_holder.start() + this->m_holder.m_size)
            , ::ndnboost::forward<U>(u) );
         ++this->m_holder.m_size;
      }
      else{
         this->priv_forward_range_insert_no_capacity
            ( vector_iterator_get_ptr(this->cend()), 1
            , this->priv_single_insert_proxy(::ndnboost::forward<U>(u)), alloc_version());
      }
   }
   ...
   void priv_shrink_to_fit(allocator_v0) NDNBOOST_CONTAINER_NOEXCEPT
   {}
   ...
   void priv_shrink_to_fit(allocator_v2) NDNBOOST_CONTAINER_NOEXCEPT
   {
      const size_type cp = this->m_holder.capacity();
      if(cp){
         const size_type sz = this->size();
                              ...
                              , bool do_skip, BiDirSkipConstIt last_skip_it, BiDirValueIt last_value_it)
   {
      ...
      while(insertions_left){
         ...
         NDNBOOST_ASSERT(pos <= old_size_pos);
   ...
   {
      NDNBOOST_ASSERT(first_pos <= last_pos);
      NDNBOOST_ASSERT(last_pos <= limit_pos);
      //
      T* const begin_ptr = container_detail::to_raw_pointer(this->m_holder.start());
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         ndnboost::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      else if((first_pos + shift_count) >= limit_pos){
         //All uninitialized_moved
         ::ndnboost::container::uninitialized_move_alloc
      ...
      //Case C:
         ...
         ::ndnboost::container::uninitialized_move_alloc(this->m_holder.alloc(), boundary_ptr, last_ptr, limit_ptr);
         //The rest is move assigned
         ndnboost::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   void priv_forward_range_insert_expand_forward(T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if (!elems_after){
         ...
         ndnboost::move_backward(pos, old_finish - n, old_finish);
         ...
         ::ndnboost::container::uninitialized_move_alloc(this->m_holder.alloc(), pos, old_finish, pos + n);
         NDNBOOST_TRY{
         ...
         NDNBOOST_CATCH(...){
            ndnboost::container::destroy_alloc_n(this->get_stored_allocator(), pos + n, elems_after);
            NDNBOOST_RETHROW
         }
         NDNBOOST_CATCH_END
      }
      ...
      (T* const new_start, size_type new_cap, T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(old_buffer){
         new_finish = ::ndnboost::container::uninitialized_move_alloc
      ...
      if(old_buffer){
         ...
         if(!value_traits::trivial_dctr_after_move)
            ndnboost::container::destroy_alloc_n(this->get_stored_allocator(), old_buffer, this->m_holder.m_size);
          ...
          T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(s_before >= before_plus_new){
         ...
         T *const new_elem_pos =
            ::ndnboost::container::uninitialized_move_alloc(this->m_holder.alloc(), old_start, pos, new_start);
         ...
         //s_before is so big that divides old_end
            ...
            if(!value_traits::trivial_dctr){
               ...
               ::ndnboost::move(pos + raw_gap, old_finish, old_start);
         ...
         if (s_before <= elemsbefore) {
            ...
            if(do_after){
               ...
               T *const next = ::ndnboost::move(old_start + s_before, pos, old_start);
               ...
               ::ndnboost::move(pos, old_finish, next + n);
               if(value_traits::trivial_dctr_after_move)
                  old_values_destroyer.release();
            }
         }
            ...
            T * const new_pos = ::ndnboost::container::uninitialized_move_alloc
            ...
            if(do_after){
               ...
               //Displace old_end
               T* const move_end = ::ndnboost::move(pos, old_finish, move_start);
               //Destroy remaining moved elements from old_end except if they
               //have trivial destructor after being moved
               size_type n_destroy = s_before - n;
               if(!value_traits::trivial_dctr_after_move)
                  ndnboost::container::destroy_alloc_n(this->get_stored_allocator(), move_end, n_destroy);
         ...
         if(do_after){
            ...
            if (elemsafter >= n_after){
               ...
               ndnboost::move_backward(pos, finish_n, old_finish);
               ...
               NDNBOOST_CATCH(...){
                  ndnboost::container::destroy_alloc_n(this->get_stored_allocator(), pos, mid_last_dist);
                  NDNBOOST_RETHROW
               }
               NDNBOOST_CATCH_END
/*
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<ndnboost::container::vector<T, Allocator> >
   : public ::ndnboost::has_trivial_destructor_after_move<Allocator>
{};


}

//#define NDNBOOST_CONTAINER_PUT_SWAP_OVERLOAD_IN_NAMESPACE_STD

#ifdef NDNBOOST_CONTAINER_PUT_SWAP_OVERLOAD_IN_NAMESPACE_STD

namespace std {

template <class T, class Allocator>
inline void swap(ndnboost::container::vector<T, Allocator>& x, ndnboost::container::vector<T, Allocator>& y)
{  x.swap(y);  }
...
#endif //   #ifndef  NDNBOOST_CONTAINER_CONTAINER_VECTOR_HPP
