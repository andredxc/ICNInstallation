...
#ifndef NDNBOOST_CONTAINER_DESTROYERS_HPP
#define NDNBOOST_CONTAINER_DESTROYERS_HPP
...
struct scoped_deallocator
{
   ...
   NDNBOOST_MOVABLE_BUT_NOT_COPYABLE(scoped_deallocator)
   ...
   scoped_deallocator(NDNBOOST_RV_REF(scoped_deallocator) o)
...
{
   typedef ndnboost::container::allocator_traits<Allocator> AllocTraits;
...
{
   typedef ndnboost::container::allocator_traits<A> AllocTraits;
   public:
...
#endif   //#ifndef NDNBOOST_CONTAINER_DESTROYERS_HPP
