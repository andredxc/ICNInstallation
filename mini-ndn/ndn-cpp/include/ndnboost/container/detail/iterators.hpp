...
#ifndef NDNBOOST_CONTAINER_DETAIL_ITERATORS_HPP
#define NDNBOOST_CONTAINER_DETAIL_ITERATORS_HPP
      ...
      <std::random_access_iterator_tag, T, Difference, const T*, const T &>
{
   ...
   //constructed until ::ndnboost::container::construct_in_place is called.
...
struct emplace_functor
{
   ...
   void inplace_impl(A &a, T* ptr, const container_detail::index_tuple<IdxPack...>&)
   {
      allocator_traits<A>::construct
         (a, ptr, ::ndnboost::forward<Args>(container_detail::get<IdxPack>(args_))...);
   }
...
#define NDNBOOST_PP_LOCAL_MACRO(n)                                                        \
   NDNBOOST_PP_EXPR_IF(n, template <)                                                     \
      NDNBOOST_PP_ENUM_PARAMS(n, class P)                                                 \
         NDNBOOST_PP_EXPR_IF(n, >)                                                        \
   struct NDNBOOST_PP_CAT(NDNBOOST_PP_CAT(emplace_functor, n), arg)                          \
   {                                                                                   \
      NDNBOOST_PP_CAT(NDNBOOST_PP_CAT(emplace_functor, n), arg)                              \
      ...
      {                                                                                \
         allocator_traits<A>::construct                                                \
            (a, ptr NDNBOOST_PP_ENUM_TRAILING(n, NDNBOOST_CONTAINER_PP_MEMBER_FORWARD, _) ); \
      }                                                                                \
...
struct iiterator_types
{
   ...
   typedef typename ::ndnboost::intrusive::pointer_traits<it_pointer>::
      template rebind_pointer<value_type>::type                      pointer;
   typedef typename ::ndnboost::intrusive::pointer_traits<it_pointer>::
      template rebind_pointer<const value_type>::type                const_pointer;
   typedef typename ::ndnboost::intrusive::
   ...
   :  public std_iterator<IIterator, IsConst>::type
{
   ...
   explicit iterator(IIterator iit) NDNBOOST_CONTAINER_NOEXCEPT
      : m_iit(iit)
   {}

   iterator(iterator<IIterator, false> const& other) NDNBOOST_CONTAINER_NOEXCEPT
      :  m_iit(other.get())
   {}

   iterator& operator++() NDNBOOST_CONTAINER_NOEXCEPT
   {  ++this->m_iit;   return *this;  }

   iterator operator++(int) NDNBOOST_CONTAINER_NOEXCEPT
   {
   ...
   iterator& operator--() NDNBOOST_CONTAINER_NOEXCEPT
   {
      ...
      NDNBOOST_STATIC_ASSERT((is_bidirectional_iterator<iterator>::value));
      --this->m_iit;   return *this;
   }
   ...
   friend bool operator== (const iterator& l, const iterator& r) NDNBOOST_CONTAINER_NOEXCEPT
   ...
   const IIterator &get() const NDNBOOST_CONTAINER_NOEXCEPT
   {  return this->m_iit;   }
...
#endif   //#ifndef NDNBOOST_CONTAINER_DETAIL_ITERATORS_HPP
