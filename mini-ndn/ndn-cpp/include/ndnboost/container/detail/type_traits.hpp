...
//
// The alignment_of implementation comes from John Maddock's ndnboost::alignment_of code
//
//////////////////////////////////////////////////////////////////////////////

#ifndef NDNBOOST_CONTAINER_CONTAINER_DETAIL_TYPE_TRAITS_HPP
#define NDNBOOST_CONTAINER_CONTAINER_DETAIL_TYPE_TRAITS_HPP
...
template<class T>
struct remove_reference< ::ndnboost::rv<T> >
{
   typedef T type;
};
...
#endif   //#ifndef NDNBOOST_CONTAINER_CONTAINER_DETAIL_TYPE_TRAITS_HPP
