...
#ifndef NDNBOOST_CONTAINER_DETAIL_MULTIALLOCATION_CHAIN_HPP
#define NDNBOOST_CONTAINER_DETAIL_MULTIALLOCATION_CHAIN_HPP
...
#include <ndnboost/container/detail/transform_iterator.hpp>
#include <ndnboost/intrusive/slist.hpp>
...
class basic_multiallocation_chain
{
   ...
   typedef bi::slist< node
                    , bi::linear<true>
                    , bi::cache_last<true>
                    , bi::size_type<typename ndnboost::make_unsigned<difference_type>::type>
                    > slist_impl_t;
   ...
   NDNBOOST_MOVABLE_BUT_NOT_COPYABLE(basic_multiallocation_chain)
   ...
   basic_multiallocation_chain(NDNBOOST_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_(::ndnboost::move(other.slist_impl_))
   {}

   basic_multiallocation_chain& operator=(NDNBOOST_RV_REF(basic_multiallocation_chain) other)
   {
      slist_impl_ = ::ndnboost::move(other.slist_impl_);
      return *this;
   }
   ...
   {
      typedef typename ndnboost::intrusive::pointer_traits<char_ptr> char_pointer_traits;
...
{
   private:
   NDNBOOST_MOVABLE_BUT_NOT_COPYABLE(transform_multiallocation_chain)
   ...
   transform_multiallocation_chain(NDNBOOST_RV_REF(transform_multiallocation_chain) other)
      : MultiallocationChain(::ndnboost::move(static_cast<MultiallocationChain&>(other)))
   {}

   transform_multiallocation_chain(NDNBOOST_RV_REF(MultiallocationChain) other)
      : MultiallocationChain(::ndnboost::move(static_cast<MultiallocationChain&>(other)))
   {}

   transform_multiallocation_chain& operator=(NDNBOOST_RV_REF(transform_multiallocation_chain) other)
   {
      return static_cast<MultiallocationChain&>
         (this->MultiallocationChain::operator=(::ndnboost::move(static_cast<MultiallocationChain&>(other))));
   }
/*
...
#endif   //NDNBOOST_CONTAINER_DETAIL_MULTIALLOCATION_CHAIN_HPP
