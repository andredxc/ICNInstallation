...
#ifndef NDNBOOST_CONTAINER_DETAIL_UTILITIES_HPP
#define NDNBOOST_CONTAINER_DETAIL_UTILITIES_HPP
...
template<class T, bool IsClass = ndnboost::is_class<T>::value >
struct has_member_swap
{
   static const bool value = ndnboost::container::container_detail::
...
template<class T> inline
typename container_detail::enable_if_c
      <!container_swap::has_member_swap<T>::value && ndnboost::has_move_emulation_enabled<T>::value, void>::type
   swap_dispatch(T &left, T &right)
{
   T temp(ndnboost::move(left)); // may throw
   left = ndnboost::move(right); // may throw
   right = ndnboost::move(temp); // may throw
}
...
struct next_capacity_calculator<SizeType, NextCapacityDouble>
{
                     ...
                     ,const SizeType n)
   {
      ...
      if ( remaining < n )
         ndnboost::container::throw_length_error("get_next_capacity, allocator's max_size reached");
...
{  return ndnboost::container::container_detail::to_raw_pointer(p.operator->());  }
...
template <class Iterator>
inline 
   typename ndnboost::intrusive::pointer_traits
...
#endif   //NDNBOOST_CONTAINER_VECTOR_ITERATOR_IS_POINTER
...
template<class Pointer>
struct are_elements_contiguous<ndnboost::container::container_detail::vector_iterator<Pointer> >
{
   static const bool value = true;
};

template<class Pointer>
struct are_elements_contiguous<ndnboost::container::container_detail::vector_const_iterator<Pointer> >
{
   static const bool value = true;
};
...
template <class PointedType, class DifferenceType, class OffsetType, std::size_t OffsetAlignment>
struct are_elements_contiguous< ::ndnboost::interprocess::offset_ptr<PointedType, DifferenceType, OffsetType, OffsetAlignment> >
{
   static const bool value = true;
};
...
struct is_memtransfer_copy_assignable
{
   static const bool value = are_contiguous_and_same<I, O>::value &&
      ndnboost::has_trivial_assign< typename ::std::iterator_traits<I>::value_type >::value;
};
...
{
   static const bool value = are_contiguous_and_same<I, O>::value &&
      ndnboost::has_trivial_copy< typename ::std::iterator_traits<I>::value_type >::value;
};
...
inline F memmove(I f, I l, F r) NDNBOOST_CONTAINER_NOEXCEPT
{
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
F memmove_n(I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
{
   typedef typename std::iterator_traits<I>::value_type value_type;
   ::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
   std::advance(r, n);
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
I memmove_n_source(I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
{
   typedef typename std::iterator_traits<I>::value_type value_type;
   ::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
   std::advance(f, n);
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
I memmove_n_source_dest(I f, typename std::iterator_traits<I>::difference_type n, F &r) NDNBOOST_CONTAINER_NOEXCEPT
{
   typedef typename std::iterator_traits<I>::value_type value_type;
   ::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
   std::advance(f, n);
...
struct is_memzero_initializable
{
   ...
   static const bool value = are_elements_contiguous<O>::value &&
      (  ::ndnboost::is_integral<value_type>::value || ::ndnboost::is_enum<value_type>::value
      #if defined(NDNBOOST_CONTAINER_MEMZEROED_POINTER_IS_NULL)
      || ::ndnboost::is_pointer<value_type>::value
      #endif
      #if defined(NDNBOOST_CONTAINER_MEMZEROED_FLOATING_POINT_IS_ZERO)
      || ::ndnboost::is_floating_point<value_type>::value
      #endif
      #if defined(NDNBOOST_CONTAINER_MEMZEROED_FLOATING_POINT_IS_ZERO) && defined(NDNBOOST_CONTAINER_MEMZEROED_POINTER_IS_NULL)
      || ::ndnboost::is_pod<value_type>::value
      #endif
      );
};
...
//!   \code
//!   for (; f != l; ++r, ++f)
//!      allocator_traits::construct(a, &*r, ndnboost::move(*f));
//!   \endcode
//!
//! <b>Returns</b>: r
template
   ...
   uninitialized_move_alloc(A &a, I f, I l, F r)
{
   ...
   NDNBOOST_TRY{
      while (f != l) {
         allocator_traits<A>::construct(a, container_detail::iterator_to_raw_pointer(r), ndnboost::move(*f));
         ++f; ++r;
      }
   }
   NDNBOOST_CATCH(...){
...
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc(A &, I f, I l, F r) NDNBOOST_CONTAINER_NOEXCEPT
...
template
   <typename A,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(A &, I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
...
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(A &, I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
...
template
   <typename A,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc(A &, I f, I l, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove(f, l, r); }
...
template
   <typename A,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(A &, I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n(f, n, r); }
...
template
   <typename A,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(A &, I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n_source(f, n, r); }
...
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   copy(I f, I l, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove(f, l, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   copy_n(I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n(f, n, r); }
...
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source(I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n_source(f, n, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source_dest(I f, typename std::iterator_traits<I>::difference_type n, F &r) NDNBOOST_CONTAINER_NOEXCEPT
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move(I f, I l, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove(f, l, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move_n(I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n(f, n, r); }
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source(I f, typename std::iterator_traits<I>::difference_type n, F r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n_source(f, n, r); }
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source_dest(I f, typename std::iterator_traits<I>::difference_type n, F &r) NDNBOOST_CONTAINER_NOEXCEPT
{  return container_detail::memmove_n_source_dest(f, n, r); }
...
inline void destroy_alloc_n(A &a, I f, typename std::iterator_traits<I>::difference_type n
   ,typename ndnboost::container::container_detail::enable_if_c
      < !ndnboost::has_trivial_destructor<typename std::iterator_traits<I>::value_type>::value >::type* = 0)
{
   while(n--){
                    ...
                    , G large_range_f, typename allocator_traits<A>::size_type n_j)
{
   ...
   for (; n != n_i ; ++short_range_f, ++large_range_f, ++n){
      ndnboost::container::swap_dispatch(*short_range_f, *large_range_f);
   }
   ndnboost::container::uninitialized_move_alloc_n(a, large_range_f, n_j - n_i, short_range_f);  // may throw
   ndnboost::container::destroy_alloc_n(a, large_range_f, n_j - n_i);
}
...
{
   if (n_o < n_i){
      inp_start = ndnboost::container::copy_n_source_dest(inp_start, n_o, out_start);     // may throw
      ndnboost::container::uninitialized_copy_alloc_n(a, inp_start, n_i - n_o, out_start);// may throw
   }
   else{
      out_start = ndnboost::container::copy_n(inp_start, n_i, out_start);  // may throw
      ndnboost::container::destroy_alloc_n(a, out_start, n_o - n_i);
   }
}
...
{
   if (n_o < n_i){
      inp_start = ndnboost::container::move_n_source_dest(inp_start, n_o, out_start);  // may throw
      ndnboost::container::uninitialized_move_alloc_n(a, inp_start, n_i - n_o, out_start);  // may throw
   }
   else{
      out_start = ndnboost::container::move_n(inp_start, n_i, out_start);  // may throw
      ndnboost::container::destroy_alloc_n(a, out_start, n_o - n_i);
   }
}
...
#endif   //#ifndef NDNBOOST_CONTAINER_DETAIL_UTILITIES_HPP
