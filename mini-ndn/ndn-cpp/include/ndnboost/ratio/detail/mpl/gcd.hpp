...
//
////////////////////////////////////////////////////////////////////
#ifndef NDNBOOST_MPL_GCD_HPP_INCLUDED
#define NDNBOOST_MPL_GCD_HPP_INCLUDED
...
#include <ndnboost/mpl/aux_/config/dependent_nttp.hpp>
...
{
    NDNBOOST_MPL_AUX_LAMBDA_SUPPORT(2, gcd, (N1, N2))
};

NDNBOOST_MPL_AUX_NA_SPEC(2, gcd)
...
namespace aux {
  ...
  template< typename T1, ndnboost::intmax_t n1, bool n1_is_0
                  , typename T2, ndnboost::intmax_t n2, bool n2_is_0 >
      struct gcd_aux
          : gcd_aux<T2, n2, n2==0, T1, (n1 % n2), (n1 % n2)==0>
      {};

      template <typename T1, ndnboost::intmax_t n1, typename T2, ndnboost::intmax_t n2>
      struct gcd_aux<T1, n1, false, T2, n2, true> : integral_c<T1, n1>
      {};

      template <typename T1, ndnboost::intmax_t n1, typename T2, ndnboost::intmax_t n2, bool C>
      struct gcd_aux<T1, n1, true, T2, n2, C> : integral_c<T2, n2>
      {};

#else // defined(NDNBOOST_MPL_CFG_NO_DEPENDENT_NONTYPE_PARAMETER_IN_PARTIAL_SPEC)
    ...
    struct gcd_aux<T1, n1, true, T2, n2, C> : integral_c<T2, n2>
    {};
#endif // defined(NDNBOOST_MPL_CFG_NO_DEPENDENT_NONTYPE_PARAMETER_IN_PARTIAL_SPEC)
}
...
#endif // NDNBOOST_MPL_GCD_HPP_INCLUDED
