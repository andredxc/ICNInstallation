...
//
////////////////////////////////////////////////////////////////////
#ifndef NDNBOOST_MPL_ABS_HPP_INCLUDED
#define NDNBOOST_MPL_ABS_HPP_INCLUDED
...
{
    NDNBOOST_MPL_AUX_LAMBDA_SUPPORT(1, abs, (N))
};

NDNBOOST_MPL_AUX_NA_SPEC(1, abs)
...
{
    NDNBOOST_STATIC_CONSTANT(T, value = (n < 0 ? -n : n));
...
#endif // NDNBOOST_MPL_ABS_HPP_INCLUDED
