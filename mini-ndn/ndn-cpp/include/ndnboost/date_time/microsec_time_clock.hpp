...
#ifdef NDNBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK
...
namespace date_time {
  ...
  private:
    ...
    {
#ifdef NDNBOOST_HAS_GETTIMEOFDAY
      timeval tv;
      gettimeofday(&tv, 0); //gettimeofday does not support TZ adjust on Linux.
      std::time_t t = tv.tv_sec;
      ndnboost::uint32_t sub_sec = tv.tv_usec;
#elif defined(NDNBOOST_HAS_FTIME)
      winapi::file_time ft;
      ...
      ndnboost::uint32_t sub_sec = static_cast<ndnboost::uint32_t>(micros % 1000000UL);
#else
#error Internal Boost.DateTime error: NDNBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK is defined, however neither gettimeofday nor FILETIME support is detected.
#endif
...
#endif //NDNBOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK
