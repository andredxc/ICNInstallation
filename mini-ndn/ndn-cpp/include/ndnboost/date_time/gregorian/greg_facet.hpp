...
#include "ndnboost/date_time/date_formatting_locales.hpp" // sets NDNBOOST_DATE_TIME_NO_LOCALE
#include "ndnboost/date_time/gregorian/parsers.hpp"

//This file is basically commented out if locales are not supported
#ifndef NDNBOOST_DATE_TIME_NO_LOCALE
...
namespace gregorian {
  ...
  {
    typedef ndnboost::gregorian::greg_month month_type;
    typedef ndnboost::date_time::special_values special_value_enum;
    typedef ndnboost::gregorian::months_of_year month_enum;
    typedef ndnboost::date_time::weekdays weekday_enum;
  };

#if defined(USE_DATE_TIME_PRE_1_33_FACET_IO)
  //! Create the base facet type for gregorian::date
  typedef ndnboost::date_time::date_names_put<greg_facet_config> greg_base_facet;
  ...
  {
    typedef ndnboost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef ndnboost::date_time::ostream_date_formatter<date, facet_def, charT> greg_ostream_formatter;
  ...
  {
    typedef ndnboost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef ndnboost::date_time::ostream_month_formatter<facet_def, charT> greg_month_formatter;
  ...
  {
    typedef ndnboost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef ndnboost::date_time::ostream_weekday_formatter<greg_weekday, facet_def, charT> greg_weekday_formatter;
    std::locale locale = os.getloc();
    if (std::has_facet<facet_def>(locale)) {
      const facet_def& f = std::use_facet<facet_def>(locale);
...
#endif // NDNBOOST_NO_STD_ITERATOR_TRAITS
  ...
  NDNBOOST_DATE_TIME_DECL std::locale generate_locale(std::locale& loc, char type);
  ...
  NDNBOOST_DATE_TIME_DECL ndnboost::date_time::all_date_names_put<greg_facet_config, char>* create_facet_def(char type);

#ifndef NDNBOOST_NO_STD_WSTRING
  //! generates a locale with the set of gregorian name-strings of type wchar_t*
  NDNBOOST_DATE_TIME_DECL std::locale generate_locale(std::locale& loc, wchar_t type);
  //! Returns a pointer to a facet with a default set of names (English)
  /* Necessary in the event an exception is thrown from op>> for 
   * weekday or month. See comments in those functions for more info */
  NDNBOOST_DATE_TIME_DECL ndnboost::date_time::all_date_names_put<greg_facet_config, wchar_t>* create_facet_def(wchar_t type);
#endif // NDNBOOST_NO_STD_WSTRING
