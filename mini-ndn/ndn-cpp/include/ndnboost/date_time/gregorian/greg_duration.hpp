...
#include <ndnboost/date_time/date_duration.hpp>
...
namespace gregorian {
  ...
  typedef ndnboost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class date_duration :
    public ndnboost::date_time::date_duration< date_duration_rep >
  {
    typedef ndnboost::date_time::date_duration< date_duration_rep > base_type;
...
#include <ndnboost/date_time/date_duration_types.hpp>
#endif
