...
#include <ndnboost/date_time/gregorian/greg_weekday.hpp>
#include <ndnboost/date_time/gregorian/greg_day_of_year.hpp>
#include <ndnboost/date_time/gregorian_calendar.hpp>
#include <ndnboost/date_time/gregorian/greg_ymd.hpp>
