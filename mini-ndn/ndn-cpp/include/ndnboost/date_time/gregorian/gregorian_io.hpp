...
#include <ndnboost/date_time/date_facet.hpp>
#include <ndnboost/date_time/period_parser.hpp>
#include <ndnboost/date_time/period_formatter.hpp>
#include <ndnboost/date_time/special_values_parser.hpp>
#include <ndnboost/date_time/special_values_formatter.hpp>
#include <ndnboost/date_time/gregorian/gregorian_types.hpp>
#include <ndnboost/date_time/gregorian/conversion.hpp> // to_tm will be needed in the facets

namespace ndnboost {
namespace gregorian {


  typedef ndnboost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef ndnboost::date_time::period_formatter<char>    period_formatter;
  
  typedef ndnboost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef ndnboost::date_time::date_facet<date,char>    date_facet;

  typedef ndnboost::date_time::period_parser<date,char>       period_parser;
  typedef ndnboost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef ndnboost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef ndnboost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef ndnboost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef ndnboost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef ndnboost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef ndnboost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::date& d) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    ndnboost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::date_duration& dd) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::date_period& dp) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::greg_month& gm) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::greg_weekday& gw) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::partial_date& pd) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::nth_day_of_the_week_in_month& nkd) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::first_day_of_the_week_in_month& fkd) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::last_day_of_the_week_in_month& lkd) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::first_day_of_the_week_after& fda) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const ndnboost::gregorian::first_day_of_the_week_before& fdb) {
    ndnboost::io::ios_flags_saver iflags(os);
    typedef ndnboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
