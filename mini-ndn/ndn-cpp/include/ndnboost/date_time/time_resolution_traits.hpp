...
#include <ndnboost/date_time/time_defs.hpp>
#include <ndnboost/date_time/int_adapter.hpp>
...
namespace date_time {
  ...
  struct time_resolution_traits_bi32_impl {
    typedef ndnboost::int32_t int_type;
    typedef ndnboost::int32_t impl_type;
  ...
  struct time_resolution_traits_adapted32_impl {
    typedef ndnboost::int32_t int_type;
    typedef ndnboost::date_time::int_adapter<ndnboost::int32_t> impl_type;
  ...
  struct time_resolution_traits_bi64_impl {
    typedef ndnboost::int64_t int_type;
    typedef ndnboost::int64_t impl_type;
    static int_type as_number(impl_type i){ return i;}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return false;}
  };
  ...
  struct time_resolution_traits_adapted64_impl {
    typedef ndnboost::int64_t int_type;
    typedef ndnboost::date_time::int_adapter<ndnboost::int64_t> impl_type;
    static int_type as_number(impl_type i){ return i.as_number();}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return true;}
  };
  ...
  template<typename frac_sec_type,
           ...
           ndnboost::int64_t resolution_adjust,
#else
           typename frac_sec_type::int_type resolution_adjust,
#endif
           unsigned short frac_digits,
           typename v_type = ndnboost::int32_t >
...
#if (defined(NDNBOOST_MSVC) && (_MSC_VER < 1300))
    NDNBOOST_STATIC_CONSTANT(ndnboost::int64_t, ticks_per_second = resolution_adjust);
#else
    NDNBOOST_STATIC_CONSTANT(fractional_seconds_type, ticks_per_second = resolution_adjust);
#endif
