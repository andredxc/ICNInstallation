...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const ndnboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const ndnboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const ndnboost::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const ndnboost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
