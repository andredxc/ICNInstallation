...
#include <ndnboost/date_time/time_duration.hpp>
#include <ndnboost/date_time/time_resolution_traits.hpp>
#include <ndnboost/date_time/gregorian/gregorian_types.hpp>
#include <ndnboost/date_time/wrapping_int.hpp>
...
//#define NDNBOOST_GDTL_POSIX_TIME_STD_CONFIG

#ifdef NDNBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG
  // set up conditional test compilations
#define NDNBOOST_DATE_TIME_HAS_MILLISECONDS
#define NDNBOOST_DATE_TIME_HAS_MICROSECONDS
#define NDNBOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<ndnboost::date_time::time_resolution_traits_adapted64_impl, ndnboost::date_time::nano,
    1000000000, 9 > time_res_traits;
#else
  // set up conditional test compilations
#define NDNBOOST_DATE_TIME_HAS_MILLISECONDS
#define NDNBOOST_DATE_TIME_HAS_MICROSECONDS
#undef  NDNBOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    ndnboost::date_time::time_resolution_traits_adapted64_impl, ndnboost::date_time::micro,
                                            1000000, 6 > time_res_traits;


// #undef NDNBOOST_DATE_TIME_HAS_MILLISECONDS
// #undef NDNBOOST_DATE_TIME_HAS_MICROSECONDS
// #undef NDNBOOST_DATE_TIME_HAS_NANOSECONDS
//   typedef date_time::time_resolution_traits<ndnboost::int64_t, ndnboost::date_time::tenth,
//                                              10, 0 > time_res_traits;
  ...
  public:
    ...
    time_duration(ndnboost::date_time::special_values sv) :
...
#else
    NDNBOOST_STATIC_CONSTANT(ndnboost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef ndnboost::int64_t time_rep_type;
...
#if (defined(NDNBOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    NDNBOOST_STATIC_CONSTANT(ndnboost::int64_t, tick_per_second = 1000000);
#endif
  };
