...
#include <ndnboost/date_time/gregorian/gregorian.hpp>
#include <ndnboost/date_time/compiler_config.hpp>
#include <ndnboost/date_time/iso_format.hpp>
#include <ndnboost/date_time/date_format_simple.hpp>
#include <ndnboost/date_time/posix_time/posix_time_types.hpp>
#include <ndnboost/date_time/time_formatting_streams.hpp>
#include <ndnboost/date_time/time_resolution_traits.hpp> // absolute_value
#include <ndnboost/date_time/time_parsing.hpp>

/* NOTE: The "to_*_string" code for older compilers, ones that define
 * NDNBOOST_DATE_TIME_INCLUDE_LIMITED_HEADERS, is located in
