...
namespace CV {
  ...
  public:
    ...
    static value_type max NDNBOOST_PREVENT_MACRO_SUBSTITUTION () {return (value_policies::max)();}
    //! Return the min allowed value (traits method)
    static value_type min NDNBOOST_PREVENT_MACRO_SUBSTITUTION () {return (value_policies::min)();}
  ...
  class simple_exception_policy
  {
    ...
    {
      // In order to support throw_exception mechanism in the NDNBOOST_NO_EXCEPTIONS mode,
  ...
  public:
    ...
    static rep_type min NDNBOOST_PREVENT_MACRO_SUBSTITUTION () { return min_value; }
    static rep_type max NDNBOOST_PREVENT_MACRO_SUBSTITUTION () { return max_value; }
    static void on_error(rep_type, rep_type, violation_enum)
    {
      ndnboost::throw_exception(actual_exception_type());
    }
  };
