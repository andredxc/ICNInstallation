...
namespace date_time {
  ...
  class date_duration : private
              ndnboost::less_than_comparable1< date_duration< duration_rep_traits >
            , ndnboost::equality_comparable1< date_duration< duration_rep_traits >
            , ndnboost::addable1< date_duration< duration_rep_traits >
            , ndnboost::subtractable1< date_duration< duration_rep_traits >
            , ndnboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef ndnboost::date_time::int_adapter<long> impl_type;
