...
#include "ndnboost/limits.hpp" //work around compilers without limits
#include "ndnboost/date_time/special_defs.hpp"
#include "ndnboost/date_time/locale_config.hpp"
...
public:
  ...
  static  int_adapter max NDNBOOST_PREVENT_MACRO_SUBSTITUTION ()
  {
    return (::std::numeric_limits<int_type>::max)()-2;
  }
  static  int_adapter min NDNBOOST_PREVENT_MACRO_SUBSTITUTION ()
  {
