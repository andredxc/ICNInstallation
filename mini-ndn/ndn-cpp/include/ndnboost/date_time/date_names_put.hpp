...
#include "ndnboost/date_time/locale_config.hpp" // set NDNBOOST_DATE_TIME_NO_LOCALE
...
namespace date_time {
    ...
    protected:
      ...
      {
        string_type s1(ndnboost::lexical_cast<string_type>(s));
