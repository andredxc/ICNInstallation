 ...
 */
#ifndef NDNBOOST_SMART_PTR_DETAIL_ARRAY_ALLOCATOR_HPP
#define NDNBOOST_SMART_PTR_DETAIL_ARRAY_ALLOCATOR_HPP

#include <ndnboost/align/align.hpp>
    ...
    namespace detail {
        ...
        public:
            ...
            pointer allocate(size_type count, const_void_pointer = 0) {
                enum {
                    M = ndnboost::alignment_of<type>::value
                };
                ...
                (void)ndnboost::alignment::align(M, n2, p2, n3);
