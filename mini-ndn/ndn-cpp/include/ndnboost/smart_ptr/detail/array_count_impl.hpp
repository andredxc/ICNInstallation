 ...
 */
#ifndef NDNBOOST_SMART_PTR_DETAIL_ARRAY_COUNT_IMPL_HPP
#define NDNBOOST_SMART_PTR_DETAIL_ARRAY_COUNT_IMPL_HPP

#include <ndnboost/smart_ptr/detail/array_allocator.hpp>
