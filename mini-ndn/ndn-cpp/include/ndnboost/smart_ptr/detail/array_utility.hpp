...
namespace ndnboost {
    namespace detail {
        typedef ndnboost::true_type  ms_is_trivial;
        typedef ndnboost::false_type ms_no_trivial;
        ...
        inline void ms_destroy(T* memory, std::size_t size) {
            ndnboost::has_trivial_destructor<T> trivial;
        ...
        inline void ms_init(T* memory, std::size_t size) {
            ndnboost::has_trivial_default_constructor<T> trivial;
